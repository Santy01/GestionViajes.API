...
namespace GestionViajes.API.Migrations
{
    ...
    [Migration("20250919054816_AddReservas")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GestionViajes.API.Models.Reserva", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CantidadPersonas = 2,
                            DestinoId = 1,
                            FechaCreacion = new DateTime(2024, 2, 10, 0, 0, 0, 0, DateTimeKind.Utc),
                            FechaFin = new DateTime(2024, 3, 15, 0, 0, 0, 0, DateTimeKind.Utc),
                            FechaInicio = new DateTime(2024, 3, 10, 0, 0, 0, 0, DateTimeKind.Utc),
                            Total = 500.00m,
                            TuristaId = 1
                        },
                        new
                        {
                            ...
                            CantidadPersonas = 1,
                            DestinoId = 3,
                            FechaCreacion = new DateTime(2024, 2, 20, 0, 0, 0, 0, DateTimeKind.Utc),
                            FechaFin = new DateTime(2024, 4, 8, 0, 0, 0, 0, DateTimeKind.Utc),
                            FechaInicio = new DateTime(2024, 4, 5, 0, 0, 0, 0, DateTimeKind.Utc),
                            Total = 150.00m,
                            TuristaId = 2
                        });
                });
            ...
            modelBuilder.Entity("GestionViajes.API.Models.Reserva", b =>
                {
                    b.HasOne("GestionViajes.API.Models.Destino", "Destino")
                        .WithMany()
                        .HasForeignKey("DestinoId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("GestionViajes.API.Models.Turista", "Turista")
                        .WithMany()
